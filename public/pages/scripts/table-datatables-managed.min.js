var TableDatatablesManaged=function(){var e=function(){var e=$("#sample_1");
e.dataTable({language:{aria:{sortAscending:": activate to sort column ascending",sortDescending:": activate to sort column descending"},
	emptyTable:"Không có dữ liệu",info:"Hiển thị _START_ đến _END_ trên tổng số _TOTAL_ bản ghi",
	infoEmpty:"Không tìm thấy bản ghi",infoFiltered:"(Tìm thấy _TOTAL_ bản ghi phù hợp trên tổng số _MAX_ bản ghi)",
	lengthMenu:"Hiển thị  _MENU_",
	search:"Tìm kiếm:",
	zeroRecords:"Không có bản ghi phù hợp",
	paginate:{previous:"Trước",next:"Sau",last:"Cuối",first:"Đầu"}},
	bStateSave:!0,lengthMenu:[[5,15,20,-1],[5,15,20,"Tất cả"]],
	pageLength:5,
	pagingType:"bootstrap_full_number",
	columnDefs:[{orderable:!1,targets:[0]},{searchable:!1,targets:[0]},{className:"dt-right"}],order:[[1,"asc"]]});
